...
<div class="container">
        ...
        1.Character data can be stored as______. <br><br>
            <div class="edit2">
        ...
        2. The maximum length of varchar columns is_______. <br><br>
            <div class="edit2">
        ...
        3. In oracle database variable length column is declared by___________. <br><br>
            <div class="edit2">
