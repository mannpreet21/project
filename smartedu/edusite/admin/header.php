	...
	<body id="homepage">
		...
		<header>
			...
			<div class="tools">
				<div class="container">
					<ul class="pull-left">
						<li><a href="tel:1800123456"><i class="fa fa-phone"></i><span>81-9199-6914</span></a></li>
						<li><a href="mailto:sweetysundh3@gmail.com"><i class="fa fa-envelope"></i><span>jeet.karam2@gmail.com</span></a></li>
					</ul>
					<ul class="pull-right">
