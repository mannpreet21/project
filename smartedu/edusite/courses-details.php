...
;
					...
					.text-light
					{
						...
						font-size: : 20px;
							...
							<div class="widget1" data-scroll-reveal >
<center> <img src="images/quizlogo.jpg" class="pics"></center>
                            <center><h4 style="font-size: 20px; font-style: cursive;">for online quiz test click on quiz button!</h4></center>
							<center><a href="qlink.php"><input type="button" value="Quiz" class="btn"></a></center>
					</div>
